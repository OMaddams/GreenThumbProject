...
namespace GreenThumbProject.Migrations
{
    ...
    [Migration("20231210002316_moreSeeds")]
            ...
            modelBuilder.Entity("GreenThumbProject.Models.InstructionModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            InstructionId = 1,
                            InstructionDescription = "Keep it in your pond",
                            PlantId = 3
                        });
                });
            ...
            modelBuilder.Entity("GreenThumbProject.Models.PlantModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PlantId = 5,
                            PlantDescription = "Azaleas bloom in the spring, their flowers often lasting several weeks.",
                            PlantName = "Azalea"
                        },
                        new
                        {
                            PlantId = 6,
                            PlantDescription = "Most species originate from East Asia and the center of diversity is in China. Countless horticultural varieties and cultivars exist.",
                            PlantName = "Chrysanthemum"
                        },
                        new
                        {
                            PlantId = 7,
                            PlantDescription = "Narcissus is a genus of predominantly spring flowering perennial plants of the amaryllis family, Amaryllidaceae. Various common names including daffodil, narcissus and jonquil, are used to describe all or some members of the genus.",
                            PlantName = "Daffodil"
                        });
                });
